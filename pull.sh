...
local_installs=("$HOME/Code/dev/www/add-ons/wp-core/wp-content/plugins/" "$HOME/Code/dev/www/wpae/wp-core/wp-content/plugins/" "$HOME/Code/dev/www/wpai/wp-core/wp-content/plugins/" "$HOME/Code/dev/www/wooco/wp-core/wp-content/plugins/")
